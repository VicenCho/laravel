                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('insert.producto') }}">
                            ...
                            <div class="form-group mb-3">
                                <input type="number" placeholder="Cantidad de producto" id="CantPro" class="form-control" name="CantPro" required autofocus>
                            ...
                            <div class="form-group mb-3">
                                <input type="text" placeholder="Categoria de producto" id="CatePro" class="form-control" name="CatePro" required autofocus>
                            ...
                            <div class="form-group mb-3">
                                <input type="number" placeholder="Precio del producto" id="PrecPro" class="form-control" name="PrecPro" required autofocus>
